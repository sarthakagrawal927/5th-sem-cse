...
char key[35][10] = {"auto","double","int","struct","break","else","long","switch","case","enum","register","typedef","char","extern","return","union","const","float","short","unsigned","continue","for","signed","void","default","goto","sizeof","voltile","do","if","static","while","printf","scanf","bool"};
...
char datatype[5][10] = { "void", "int", "float","bool","char"};
...
int main(int argc, char const *argv[])
{
	...
	while(ca != EOF){
		...
		// is a word ->  keyword / datatype / variable
